            ...
            .responseDecodable(of: RegisterResponse.self) { response in
                ...
                case .success(let response):
                    ...
                    // 실패했을 때
                        ...
                        case 2021: delegate.failedToRegister(message: "상품 사진을 등록해주세요.")
                        case 2018: delegate.failedToRegister(message: "상품명을 2글자 이상 입력해주세요.")
                        case 2019: delegate.failedToRegister(message: "카테고리를 선택해주세요.")
                        default: delegate.failedToRegister(message: "피드백을 주세요")
                        }
                    }
                case .failure(let error):
                    ...
                    debugPrint(error)
                    delegate.failedToRegister(message: "서버와의 연결이 원활하지 않습니다")
                }
            }
    }
}
